...
fn get_stats_200() {
    ...
    assert_eq!(
        ...
        Some(
            r#"{"id":"1","type":"stats","attributes":{"base_hp":45,"base_attack":49,"base_defence":49,"base_speed":45,"base_special":65,"types":[{"id":"22","type":"types","attributes":{"name":"GRASS"},"links":{"self":"http://localhost:8080/v1/types/22"}},{"id":"3","type":"types","attributes":{"name":"POISON"},"links":{"self":"http://localhost:8080/v1/types/3"}}],"catch_rate":45,"base_exp_yield":64},"links":{"self":"http://localhost:8080/v1/stats/1"}}"#
                .to_string()
        )
    );
...
fn post_stats_202() {
    ...
    assert_eq!(
        response.body_string(),
        Some(
            r#"{"id":"1","type":"stats","attributes":{"base_hp":42,"base_attack":42,"base_defence":42,"base_speed":42,"base_special":42,"types":[{"id":"0","type":"types","attributes":{"name":"NORMAL"},"links":{"self":"http://localhost:8080/v1/types/0"}},{"id":"0","type":"types","attributes":{"name":"NORMAL"},"links":{"self":"http://localhost:8080/v1/types/0"}}],"catch_rate":42,"base_exp_yield":42},"links":{"self":"http://localhost:8080/v1/stats/1"}}"#
                .to_string()
        )
    );
