...
fn get_tm_200() {
    ...
    assert_eq!(
        ...
        Some(
            r#"{"id":"1","type":"tms","attributes":{"move":{"id":"5","type":"moves","attributes":{"name":"MEGA PUNCH"},"links":{"self":"http://localhost:8080/v1/moves/5"}}},"links":{"self":"http://localhost:8080/v1/tms/1"}}"#
                .to_string()
        )
    );
...
fn post_tms_202() {
    ...
    assert_eq!(
        response.body_string(),
        Some(
            r#"{"id":"1","type":"tms","attributes":{"move":{"id":"1","type":"moves","attributes":{"name":"POUND"},"links":{"self":"http://localhost:8080/v1/moves/1"}}},"links":{"self":"http://localhost:8080/v1/tms/1"}}"#
                .to_string()
        )
    );
