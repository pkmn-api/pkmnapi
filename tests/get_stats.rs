...
mod tests {
    ...
    get_stats_test!(get_stats_38, 38, 73, 76, 75, 100, 100, vec![20, 20], 75, 178);
    ...
    get_stats_test!(get_stats_64, 64, 40, 35, 30, 105, 120, vec![24, 24], 100, 145);
    get_stats_test!(get_stats_65, 65, 55, 50, 45, 120, 135, vec![24, 24], 50, 186);
    ...
    get_stats_test!(get_stats_78, 78, 65, 100, 70, 105, 80, vec![20, 20], 60, 192);
    ...
    get_stats_test!(get_stats_98, 98, 30, 105, 90, 50, 25, vec![21, 21], 225, 115);
    get_stats_test!(get_stats_99, 99, 55, 130, 115, 75, 50, vec![21, 21], 60, 206);
    get_stats_test!(get_stats_100, 100, 40, 30, 50, 100, 55, vec![23, 23], 190, 103);
    get_stats_test!(get_stats_101, 101, 60, 50, 70, 140, 80, vec![23, 23], 60, 150);
    get_stats_test!(get_stats_102, 102, 60, 40, 80, 40, 60, vec![22, 24], 90, 98);
    get_stats_test!(get_stats_103, 103, 95, 95, 85, 55, 125, vec![22, 24], 45, 212);
    ...
    get_stats_test!(get_stats_112, 112, 105, 130, 120, 40, 45, vec![4, 5], 60, 204);
    get_stats_test!(get_stats_113, 113, 250, 5, 5, 50, 105, vec![0, 0], 30, 255);
    get_stats_test!(get_stats_114, 114, 65, 55, 115, 60, 100, vec![22, 22], 45, 166);
    get_stats_test!(get_stats_115, 115, 105, 95, 80, 90, 40, vec![0, 0], 45, 175);
    get_stats_test!(get_stats_116, 116, 30, 40, 70, 60, 70, vec![21, 21], 225, 83);
    get_stats_test!(get_stats_117, 117, 55, 65, 95, 85, 95, vec![21, 21], 75, 155);
    get_stats_test!(get_stats_118, 118, 45, 67, 60, 63, 50, vec![21, 21], 225, 111);
    get_stats_test!(get_stats_119, 119, 80, 92, 65, 68, 80, vec![21, 21], 60, 170);
    get_stats_test!(get_stats_120, 120, 30, 45, 55, 85, 70, vec![21, 21], 225, 106);
    get_stats_test!(get_stats_121, 121, 60, 75, 85, 115, 100, vec![21, 24], 60, 207);
    get_stats_test!(get_stats_122, 122, 40, 45, 65, 90, 100, vec![24, 24], 45, 136);
    get_stats_test!(get_stats_123, 123, 70, 110, 80, 105, 55, vec![7, 2], 45, 187);
    get_stats_test!(get_stats_124, 124, 65, 50, 35, 95, 95, vec![25, 24], 45, 137);
    get_stats_test!(get_stats_125, 125, 65, 83, 57, 105, 85, vec![23, 23], 45, 156);
    get_stats_test!(get_stats_126, 126, 65, 95, 57, 93, 85, vec![20, 20], 45, 167);
    get_stats_test!(get_stats_127, 127, 65, 125, 100, 85, 55, vec![7, 7], 45, 200);
    get_stats_test!(get_stats_128, 128, 75, 100, 95, 110, 70, vec![0, 0], 45, 211);
    get_stats_test!(get_stats_129, 129, 20, 10, 55, 80, 20, vec![21, 21], 255, 20);
    get_stats_test!(get_stats_130, 130, 95, 125, 79, 81, 100, vec![21, 2], 45, 214);
    get_stats_test!(get_stats_131, 131, 130, 85, 80, 60, 95, vec![21, 25], 45, 219);
    ...
    get_stats_test!(get_stats_134, 134, 130, 65, 60, 65, 110, vec![21, 21], 45, 196);
    get_stats_test!(get_stats_135, 135, 65, 65, 60, 130, 110, vec![23, 23], 45, 197);
    get_stats_test!(get_stats_136, 136, 65, 130, 60, 65, 110, vec![20, 20], 45, 198);
    get_stats_test!(get_stats_137, 137, 65, 60, 70, 40, 75, vec![0, 0], 45, 130);
    get_stats_test!(get_stats_138, 138, 35, 40, 100, 35, 90, vec![5, 21], 45, 120);
    get_stats_test!(get_stats_139, 139, 70, 60, 125, 55, 115, vec![5, 21], 45, 199);
    get_stats_test!(get_stats_140, 140, 30, 80, 90, 55, 45, vec![5, 21], 45, 119);
    get_stats_test!(get_stats_141, 141, 60, 115, 105, 80, 70, vec![5, 21], 45, 201);
    get_stats_test!(get_stats_142, 142, 80, 105, 65, 130, 60, vec![5, 2], 45, 202);
    get_stats_test!(get_stats_143, 143, 160, 110, 65, 30, 65, vec![0, 0], 25, 154);
    get_stats_test!(get_stats_144, 144, 90, 85, 100, 85, 125, vec![25, 2], 3, 215);
    get_stats_test!(get_stats_145, 145, 90, 90, 85, 100, 125, vec![23, 2], 3, 216);
    get_stats_test!(get_stats_146, 146, 90, 100, 90, 90, 125, vec![20, 2], 3, 217);
    get_stats_test!(get_stats_147, 147, 41, 64, 45, 50, 50, vec![26, 26], 45, 67);
    get_stats_test!(get_stats_148, 148, 61, 84, 65, 70, 70, vec![26, 26], 45, 144);
    get_stats_test!(get_stats_149, 149, 91, 134, 95, 80, 100, vec![26, 2], 45, 218);
    get_stats_test!(get_stats_150, 150, 106, 110, 90, 130, 154, vec![24, 24], 3, 220);
    get_stats_test!(get_stats_151, 151, 100, 100, 100, 100, 100, vec![24, 24], 45, 64);
}
