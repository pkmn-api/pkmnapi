...
macro_rules! set_stats_test {
    ($test_name: ident, $pokedex_id: expr, $base_hp: expr, $base_attack: expr, $base_defence: expr, $base_speed: expr, $base_special: expr, $type_ids: expr, $catch_rate: expr, $base_exp_yield: expr, $patch_offset: expr, $patch_data: expr) => {
        #[test]
        #[ignore]
...
#[rustfmt::skip::macros(set_stats_test)]

set_stats_test!(set_states_1, 1, 0x01, 0x02, 0x03, 0x04, 0x05, vec![0x06, 0x07], 0x08, 0x09, 0x383DE, vec![0x01, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09]);
set_stats_test!(
    set_states_2,
    2,
    0x01,
