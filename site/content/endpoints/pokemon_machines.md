...
|-----------------------------------------------------------------|---------------------------------|
| [GET /v1/pokemon/machines](#get-pokemon-machines-all)           | Gets a list of Pokémon machines |
...
### GET /v1/pokemon/machines {#get-pokemon-machines-all}

Gets a list of Pokémon machines
...
{% api_response() %}
{
    ...
    "links": {
        "self": "{{API_DOMAIN}}/v1/pokemon/machines"
    }
}
{% end %}
