use pkmnapi_api::responses::trainer_names::TrainerNameResponseAll;
use rocket::http::{ContentType, Status};
use serde_json::json;

mod common;

test!(get_trainer_name_all_200, (client, access_token) {
    let request = client
    ...
    let body = common::load_json::<TrainerNameResponseAll>("../secrets/data/json/get_trainer_name_all_200.json");
