use pkmnapi_api::responses::move_names::MoveNameResponseAll;
use rocket::http::{ContentType, Status};
use serde_json::json;

mod common;

test!(get_move_name_all_200, (client, access_token) {
    let request = client
        .get("/v1/moves/names")
    ...
    let body = common::load_json::<MoveNameResponseAll>("../secrets/data/json/get_move_name_all_200.json");
