use pkmnapi_api::responses::tm_prices::TMPriceResponseAll;
use rocket::http::{ContentType, Status};
use serde_json::json;

mod common;

test!(get_tm_price_all_200, (client, access_token) {
    let request = client
        .get("/v1/tms/prices")
    ...
    let body = common::load_json::<TMPriceResponseAll>("../secrets/data/json/get_tm_price_all_200.json");
