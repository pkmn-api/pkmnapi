use pkmnapi_api::responses::pokemon_evolutions::PokemonEvolutionsResponseAll;
use rocket::http::{ContentType, Status};
use serde_json::json;

mod common;

test!(get_pokemon_evolutions_all_200, (client, access_token) {
    let request = client
    ...
    let body = common::load_json::<PokemonEvolutionsResponseAll>("../secrets/data/json/get_pokemon_evolutions_all_200.json");
