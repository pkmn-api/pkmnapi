        ...
        rocket::ignite()
            ...
            .mount(
                ...
                routes![
                    ...
                    routes::mart_items::get_mart_items_all,
                    routes::mart_items::get_mart_items,
                    routes::mart_items::post_mart_items,
                    routes::move_names::get_move_name_all,
                    routes::move_names::get_move_name,
                    routes::move_names::post_move_name,
                    routes::move_stats::get_move_stats_all,
                    routes::move_stats::get_move_stats,
                    routes::move_stats::post_move_stats,
                    ...
                    routes::pokemon_movesets::get_pokemon_moveset_all,
                    routes::pokemon_movesets::get_pokemon_moveset,
                    routes::pokemon_movesets::post_pokemon_moveset,
                    ...
                    routes::tm_names::get_tm_name_all,
                    routes::tm_names::get_tm_name,
                    routes::tm_prices::get_tm_price_all,
                    routes::tm_prices::get_tm_price,
                    routes::tm_prices::post_tm_price,
                    routes::trades::get_trade_all,
                    routes::trades::get_trade,
                    routes::trades::post_trade,
